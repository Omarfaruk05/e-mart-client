...
const BestSelling = () => {
    const bestSellings = [1, 2, 3]
    return (
        <div>
            <div>
                <h2 className='text-3xl font-bold uppercase'>Best Selling</h2>
                <hr />
                {
                    ...
                    <div className="my-8 pt-4 p-2 flex gap-3 justify-between border shadow-md">
                        ...
                        <div className="w-2/3 relative">
                            ...
                            <div className='fons-semibold text-center flex justify-around gap-4 absolute bottom-1 right-2 w-full'>
                                <p className='text-sm cursor-pointer btn btn-sm btn-primary px-2 py-1uppercase font-semibold w-1/2 '>Buy Now</p>
