        ...
        >
          ...
          ></div>
          {
            ...
            <div className="text w-1/2" data-swiper-parallax="0">
              <div>
                <h3 className="text-2xl font-bold mb-8">Asus Zendpas 7</h3>
                <h2 className="text-3xl font-semibold text-green-500">$120</h2>
                <div className="mt-28 mx-auto w-full  h-5 rounded-lg bg-green-500">
                </div>
                <div className="flex justify-between items-center px-20 mt-3">
                    <h4 className="text-gray-500 text-lg font-semibold  ">Sold: <span className="text-black">2</span></h4>
                    <h4 className="text-gray-500 text-lg font-semibold  ">Available: <span className="text-black">0</span></h4>
                </div>
              </div>
            </div>
          </SwiperSlide>
