        ...
        <div className="md:flex jsutify-between gap-5 my-4">
          <div className="md:w-2/3 px-2">
            ...
            <div className="my-4 p-4 bg-base-100 rounded">
              ...
              <div>
                <img className="w-full mx-auto" src={productPhoto} alt="" />
              </div>
              <p>
                The MAG Series Was Born Through Rigorous Quality Testing And
                Designed To Be A Symbol Of Sturdiness And Durability. Focused On
                Providing The Best User Experience, The MAG Series Has A Simple
                Installation Process Coupled With A Friendly User Interface
                Making It The Best Choice For Entry Level Gamers. Visualize Your
                Victory With MSI Optix MAG245R2 Esports Gaming Monitor. Equipped
                With A 1920x1080, 170hz Refresh Rate, 1ms Response Time Panel,
                Optix MAG245R2 Will Give You The Competitive Edge You Need To
                Take Down Your Opponents. Enjoy Extremely Smooth, Tear-Free
                Gameplay With Built-In NVIDIA G-SYNC Compatible Technology When
                Paired With A Compatible NVIDIA Graphics Card. Make Sure You Can
                Hit Your Mark With All The Latest Technologies Built-In The MSI
                Esports Gaming Monitors For Competitive Play.MSI Gaming Monitors
                Are Equipped With A 170Hz Refresh Rate + 1ms Response Time IPS
                Panel Which Has The Most Benefit In Fast Moving Game Genres Such
                As First Person Shooters, Fighters, Racing Sims, Real-Time
                Strategy, And Sports. These Type Of Games Require Very Fast And
                Precise Movements, Which An Ultra-High Refresh Rate And Fast
                Response Time Monitor Will Put You Ahead Of Your Competition.
              </p>
            </div>
            {/* Review Section  */}
            <div className="my-4">
